...
beautiful.init(themes_dir .. "gtk/theme.lua")
...
local function set_wallpaper()
    -- Wallpaper
    awful.spawn.with_shell(background)
end
...
globalkeys = gears.table.join(
    ...
    -- Show Rofi Calc
    awful.key({ modkey, "Control" }, "=", function() awful.spawn("=") end,
              {description = "rofi calc", group = "launcher"}),

    -- Lock Screen
    awful.key({ modkey }, "Escape", function() awful.spawn(lockscreen) end,
    ...
    awful.key({ modkey, "Shift" }, "r", function() awful.spawn("dmenu-remmina") end,
              {description = "Remmina Launcher", group = "launcher"}),

    -- Display Config
    awful.key({ modkey, "Shift" }, "d", function() awful.spawn("dmenu-display-config") end,
    ...
    -- Evolution
    awful.key({ modkey }, "F4", function() awful.spawn("evolution") end,
              {description = "Evolution", group = "applications"}),
...
awful.rules.rules = {
    ...
    -- Set evolution to always map on the tag named "4" on screen 1.
...
client.connect_signal("manage", function (c)
    ...
    --
    -- Set rounded corners just for fun
